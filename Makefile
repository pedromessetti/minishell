...
SRCS =  src/checks.c src/child_process.c src/cmd_tb.c src/env.c src/lex.c src/main.c src/parser.c src/path.c src/tokens.c src/lex_utils.c src/exec.c src/sig.c src/env_utils.c src/cmd_std.c src/redirections.c src/tokens_utils.c src/utils.c
